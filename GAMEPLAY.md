...
- **Dr. Null (The Villain):** A mad scientist coordinating robotic attacks from his command center. In Level 6 (Mixed Mastery Boss Wave), Dr. Null enters the battlefield directly as the active boss, wearing a retro CRT computer monitor casing on his chest that displays the math problem. The handheld controller he usually holds is hidden, and his arms are moved to the sides, ensuring the screen is completely unobstructed.
